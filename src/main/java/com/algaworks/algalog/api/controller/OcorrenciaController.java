...
public class OcorrenciaController {
	...
	private RegistroOcorrenciaService resgistroOcorrenciaService;
	...
	Ocorrencia ocorrenciaRegistrada = resgistroOcorrenciaService.registrar(entregaId, ocorrenciaInput.getDescricao());
